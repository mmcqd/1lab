...
module _ 
  ...
  D×E* : is-discrete-cartesian-fibration D → is-discrete-cartesian-fibration E → is-discrete-cartesian-fibration (D D× E)
  D×E* D* E* .fibre-set x = hlevel 2 where
    open is-discrete-cartesian-fibration D*
    open is-discrete-cartesian-fibration E*
  D×E* D* E* .cart-lift f (Dy' , Ey') = Equiv→is-hlevel 0 (Σ-swap-Σ e⁻¹) (Σ-is-hlevel 0 (D* .cart-lift f Dy') λ _ → E* .cart-lift f Ey')
